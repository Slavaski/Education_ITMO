...
MainWindow::MainWindow(QWidget *parent)
    ...
    connect(ui->showTable, &QPushButton::clicked,
            this, &MainWindow::showTable);
    connect(ui->queryTable,  &QPushButton::clicked,
            this, &MainWindow::initQuery);
    connect(ui->add, &QPushButton::clicked,
            this, &MainWindow::addStroke);
    connect(ui->delete_2, &QPushButton::clicked,
            this, &MainWindow::deleteStroke);
    connect(ui->save, &QPushButton::clicked,
            this, &MainWindow::updateStroke);
    connect(ui->spinBox, &QSpinBox::textChanged,
            this, &MainWindow::change);
    connect(ui->Table, &QComboBox::currentTextChanged,
            this, &MainWindow::changeTable);
}
